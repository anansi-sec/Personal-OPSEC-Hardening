...
- Run Kernel Check: Use kernel-hardening-checker to verify KSPP alignment.
- Apply Debian Hardening: Utilize Debian-Hardening scripts for AppArmor profiles.
...
- Infrastructure: Awesome-Red-Teaming - Focus on Cloud Redirectors.
- Evasion: CheckPlease - Use for sandbox-aware payloads.
